...
$(document).ready(function() 
{
	...
	{
		$("body").prepend("<div class='msgcookie'><div class='contenido_msg'><span class='advice'></span><p>En esta web utilizamos cookies con fines estadísticos para optimizar la funcionalidad y proporcionar de esta forma contenidos a la medida de sus intereses. Puede aceptar su uso pulsando en “Aceptar”. Si quiere saber más sobre la Ley de Cookies pulse <a href='aviso_legal.php' target='_blank'>AQUÍ</a><a href='#' class='close'></a></p></div></div>");
...
if ((!$.cookie("msgcookie"))&&(misVariablesGet.lan == 'gl'))
	{
		$("body").prepend("<div class='msgcookie'><div class='contenido_msg'><span class='advice'></span><p></a>Nesta web usamos cookies pra fins estatísticos pra optimizar a funcionalidade e, así, ofrecer contidos adaptados ós seus intereses. Pode aceptar o uso coa premendo en “Aceptar”. Se quere saber máis sobre a Lei de Cookies prema <a href='aviso_legal.php?lan=gl' target='_blank'>AQUÍ</a><a href='#' class='close'></a></p></div></div>");
