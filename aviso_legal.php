...
if($idioma == 'es' || $idioma == '') { ?>
    ...
    <head lang="es">
        <meta charset="UTF-8">
        <title>AVISO LEGAL - AT DISEÑO WEB</title>
        ...
        <meta name="twitter:image" content="meta/aviso_legal.png">

        <!-- Open Graph data -->
        <meta property="og:title" content="AT Diseño Web" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="http://adriproba.esy.es/" />
        <meta property="og:image" content="meta/aviso_legal.png" />
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/es/cuerpo_aviso_legal.php"; ?>
        </div>
...
if($idioma == 'en') { ?>
    ...
    <head lang="es">
        <meta charset="UTF-8">
        <title>LEGAL WARNING - AT DISEÑO WEB</title>
        <link rel="stylesheet" href="css/cookie.css" />
        <link rel="shortcut icon" href="img/favicon.png">
        <link href='https://fonts.googleapis.com/css?family=Raleway:400,700,300' rel='stylesheet' type='text/css'>
        <meta name="viewport" content="width=device-width,initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/en/cuerpo_aviso_legal.php"; ?>
        </div>
...
if($idioma == 'gl') { ?>
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/gl/cuerpo_aviso_legal.php"; ?>
        </div>
