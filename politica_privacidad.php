...
if($idioma == 'es' || $idioma == '') { ?>
    ...
    <head lang="es">
        <meta charset="UTF-8">
        <title>POLÍTICA DE PRIVACIDAD - AT DISEÑO WEB</title>
        ...
        <meta name="twitter:image" content="meta/politica_privacidad.png">

        <!-- Open Graph data -->
        <meta property="og:title" content="AT Diseño Web" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="http://adriproba.esy.es/" />
        <meta property="og:image" content="meta/politica_privacidad.png" />
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/es/cuerpo_politica_privacidad.php"; ?>
        </div>
...
if($idioma == 'en') { ?>
    ...
    <head lang="es">
        <meta charset="UTF-8">
        <title>PRIVACY POLICY - AT DISEÑO WEB</title>
        <link rel="stylesheet" href="css/cookie.css" />
        <link rel="shortcut icon" href="img/favicon.png">
        <link href='https://fonts.googleapis.com/css?family=Raleway:400,700,300' rel='stylesheet' type='text/css'>
        <meta name="viewport" content="width=device-width,initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/en/cuerpo_politica_privacidad.php"; ?>
        </div>
...
if($idioma == 'gl') { ?>
    ...
    <head lang="es">
        <meta charset="UTF-8">
        <title>POLÍTICA DE PRIVACIDADE - AT DISEÑO WEB</title>
        <link rel="stylesheet" href="css/cookie.css" />
        <link rel="shortcut icon" href="img/favicon.png">
        <link href='https://fonts.googleapis.com/css?family=Raleway:400,700,300' rel='stylesheet' type='text/css'>
        <meta name="viewport" content="width=device-width,initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/gl/cuerpo_politica_privacidad.php"; ?>
        </div>
