...
if($idioma == 'es' || $idioma == '') { ?>
    ...
    <head lang="es">
        <meta charset="UTF-8">
        <title>WEB1 - AT DISEÑO WEB</title>
        ...
        <meta name="twitter:image" content="meta/web.png">
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/es/cuerpo_web1.php"; ?>
        </div>
...
if($idioma == 'en') { ?>
    ...
    <head lang="es">
        ...
        <meta property="og:type" content="website" />
        <meta property="og:url" content="http://adriproba.esy.es/" />
        <meta property="og:image" content="meta/web.png" />
        <meta property="og:image:width" content="400" />
        <meta property="og:image:height" content="300" />
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/en/cuerpo_web1.php"; ?>
        </div>
...
if($idioma == 'gl') { ?>
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/gl/cuerpo_web1.php"; ?>
        </div>
