...
if($idioma == 'es' || $idioma == '') { ?>
    ...
    <head lang="es">
        <meta charset="UTF-8">
        <title>CONTACTO - AT DISEÑO WEB</title>
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/es/cuerpo_contacto.php"; ?>
        </div>
...
if($idioma == 'en') { ?>
    ...
    <head lang="es">
        <meta charset="UTF-8">
        <title>CONTACT - AT DISEÑO WEB</title>
        <link rel="stylesheet" href="css/cookie.css" />
        <link rel="shortcut icon" href="img/favicon.png">
        <link href='https://fonts.googleapis.com/css?family=Raleway:400,700,300' rel='stylesheet' type='text/css'>
        <meta name="viewport" content="width=device-width,initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/en/cuerpo_contacto.php"; ?>
        </div>
...
if($idioma == 'gl') { ?>
    ...
    <body>
        ...
        <div class="container">
            <?php include "lng/gl/cuerpo_contacto.php"; ?>
        </div>
